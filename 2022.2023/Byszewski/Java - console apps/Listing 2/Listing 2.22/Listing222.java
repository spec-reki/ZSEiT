...
public class Listing222
{
    public static void main( String[] args )
    {
        ...
        pytanie, tytul, JOptionPane.YES_NO_CANCEL_OPTION,
        JOptionPane.QUESTION_MESSAGE, null, propozycje, propozycje[1]);

        switch ( odpowiedz )
        {
            case JOptionPane.YES_OPTION : komunikat = "TAK"; break;
            case JOptionPane.NO_OPTION : komunikat = "NIE"; break;
            case JOptionPane.CANCEL_OPTION : komunikat = "ANULUJ"; break;
